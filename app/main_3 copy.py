...
sys.path.append(r"C:\Users\suley\OneDrive\Desktop\FastAPI_Course_1\app\database.py")
sys.path.append(r"C:\Users\suley\OneDrive\Desktop\FastAPI_Course_1\app\models.py")


import models
from database import engine, SessionLocal   ## "from ."  means its goinf to be imported from  current directory which is the folder "app"
